...
from src.reporting.visualizations import Visualizations
...
def main():
    ...
    db_path = os.path.join(base_dir, "data", "news_data_v2.db")
    
    # 1. Initialize Modules
    pipeline = DataPipeline(db_path=db_path)
    sentiment_engine = SentimentEngine()
    viz = Visualizations(output_dir=os.path.join(base_dir, "data", "plots"))
    ...
    report_output_path = os.path.join(base_dir, "data", "daily_report")
